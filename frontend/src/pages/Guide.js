...
function Guide() {
    return (
        ...
        <h3 style={{ textAlign: "center" }}>How to use this website</h3>
        ...
        <AccordionDetails>
                ...
                <h5>Why sell on Mosganda?</h5>
                
                <p><span className='guide-ul-span'>Make more money:</span> Mosganda allows you to bring your business online, and make unlimited sales. Thereby, making more money.</p>
                <p><span className='guide-ul-span'>Retain your brand identity:</span> You sell on Mosganda with your business/store name. So your brand identity remains intact.</p>
                <p><span className='guide-ul-span'>Online customer base:</span> Through the Mosganda chat, sellers can create business group(s) to constantly interact with customers.</p>
                  <p><span className='guide-ul-span'>Location:</span> One can sell from any town/city in Nigeria at anytime.</p>
                  <p><span className='guide-ul-span'>No design skills:</span> You do not need a graphic designer to create your online store. All that is needed is for you to click on "Create Store" button and fill in your store information.</p>
                <p><span className='guide-ul-span'>Customer support:</span> We have 24/7 support for all our customers.</p>
                <p><span className='guide-ul-span'>No product limitation:</span> Any item you can sell legally in your physical store can also be sold on Mosganda.</p>
                <p><span className='guide-ul-span'>Low commission:</span> We charge you as low as 3% when you have successfully made a sale. We only make money when you make money.</p>
        ...
        <AccordionDetails>
                ...
                <h5>Register</h5>
                  ...
                  <p>Visit mosganda.com, click on <b>Register</b> at the top-right of the page.</p>
                  <p>Enter your name, email, and password.</p>
                <p>Click on the <b>Register</b> button. A link will be sent to your email address. Login to your email, and click on the link to verify your email.</p>
                
                
                <h5>Login</h5>
               
                  <p>At the top of the page, click on the <b>Login</b> button. Enter your email and password.</p>
                  <p>Click on <b>Login</b></p>
              ...
              <p>If you are logged in, but want to logout.</p>
                ...
                <p>Move the mouse to your name at the top of the page.</p>
                <p>In the dropdown, click on <b>Logout</b></p>
      ...
      <Accordion>
        ...
        <AccordionDetails>
                  ...
                  <p>Click on the image or name of the product or click on the <b>Details</b> button. This will take you to the product detail page where you get more information about the product, the store from which the item is listed, the name of the seller, and the delivery capacity of the seller/store. Here, you can also select the quantity if you are buying in bulk.</p>
                  <p>Click on the <b>Add to Shopping Basket</b> button. This will take you to the shopping basket page.</p>
                  <p>Click on <b>Proceed to Checkout</b> button. Here, if you are not logged in, you will be required to log in before going to the next page. If you have not registered, then you need to both register and log in. If you are already logged in, continue.</p>
                  <p>Fill the <b>Shipping Address</b> form so that the seller can send you your items. Click on <b>Continue</b>.</p>
                  <p>Select your preferred payment method, and click on <b>Continue</b>. This will take you to the summary of your order.</p>
                  <p>Click on <b>Place Order</b>. This will take you to the Payment Page.</p>
                  <p>Click on <b>Pay Now (PayStack)</b> button. In the pop-up, select either to pay with card or bank or USSD and enter your private/payment information.</p>
                  <p>Click on <b>Pay</b>. If payment is successful. That is all. Check your email for payment receipt.</p>
                
                <p>Mosganda will notify the seller, and he is going to send you your items.</p>
              <p>To always view your order, at the top of the screen, move your mouse to your name. In the dropdown menu, click on <b>My Orders</b>.</p>
              <h5>What to do when your goods are sent to you.</h5>
              ...
              <p>Here, you see the <q>Comfirm Delivered</q> button, and the <q>Customer Complain Form</q> button.</p>
                ...
                <p>Click on the <q>Confirm Delivered</q> button to let Mosganda know that you have received the item(s).</p>
              <p>If you have a complain, maybe you were sent a different item from the one you ordered, click on the <q>Customer Complain Form</q> button, fill and submit your complain. Mosganda will pick it up.</p>
        ...
        >
          <Typography><h2 className='guide-h2'>How can I buy two or more items from a seller at once?</h2></Typography>
            ...
            <AccordionDetails>
              <h5>Buy two or more items</h5>
              <p>Register and login</p>
              
                  <p>Click on the image or name of the product or click on the <q>Details</q> button. This will take you to the product detail page where you get more information about the product, the store that is selling the product, and also the name of the seller. Here, you can also select the quantity if you are buying in bulk.</p>
                <p>Click on the <q>Add to Shopping Basket</q> button. This will take you to the shopping basket page.</p>
                <p>Click on the <q>view-store</q> button.</p>
                <p>In the seller store, click on the image or name of the product or click on the <q>Details</q> button. This will take you again to the product detail page.</p>
                <p>Click on the <q>Add to Shopping Basket</q> button. This will take you again to the shopping basket page. Now, if you look at the <q>Basket</q> button on top of the screen, you will see an increase in number of items you have added to the basket.</p>
                  ...
                  <p>Click on <q>Proceed to Checkout</q> button. Here, if you are not logged in, you will be required to log in before going to the next page. If you have not registered, then you need to both register and log in. If you are already logged in, continue.</p>
                  <p>Fill the <q>Shipping Address</q> form so that the seller can send you your items. Click on <q>Continue</q></p>
                  <p>Select your preferred payment method, and click on <q>Continue</q>. This will take you to the summary of your order.</p>
                  <p>Click on <q>Place Order</q>. This will take you to the Payment Page.</p>
                  <p>Click on <q>Pay Now (PayStack)</q> button. In the pop-up, select either to pay with card or bank or USSD and enter your private information</p>
                  <p>Click on <q>Pay</q>. If payment is successful. That is all. Check your email for payment receipt</p>
        ...
        <AccordionDetails>
              ...
              <p>To sell on Mosganda, you just need three steps.</p>
                ...
                <p>Once you have logged in to your account.</p>
                  ...
                  <p>Click on <q>Create Store</q> button at the top of the screen. You can also find <q>Create Store</q> link from the dropdown that appears when you move the mouse over your name, at the top of the screen.</p>
                  <p>Fill the <q>Create Store</q> form with information about your store</p>
                  <p>Click <q>Create</q>. If successful, you will be redirected to your store.</p>
                  <p>To access your store any other time, login if you are not logged in, move the mouse over your name at the top of the screen.</p>
                  <p>In the dropdown, click on the <q>Userstore</q> button. In your store, you can do the following:</p>
                ...
                <h5>Add Items To Your Store</h5>
                <p>Now that you have created your store, you can start adding items you want to sell.</p>
                
                  <p>In your store, click on the <q>Add items for sale</q> button.</p>
                  <p>Enter the information about the item and click <q>Create Product</q>. Repeat this step to add more items for sale.</p>
               
                
                <h5>Post and Unpost Store</h5>
                ...
                <h5>Post and Unpost Products/Items</h5>
              ...
              <p>When you click on the <q>Lock Store</q> button, you will need to fill in the date you are going to open store again. Clicking on the Lock Store button will remove your store from the <q>Stores</q> page, and all your products from the <q>homepage</q>. Once your store is locked, the <q>Open Store</q> button will be available in your store. After opening your store, you will have to post your store and items again to make them available for sale. </p>
                ...
                <p>Your store url or link is displayed in your store. It is made up of our domain name and your business name. It looks like this: https://www.mosganda.com/your-bsiness-name</p>
      ...
      <Accordion>
          ...
          <Typography><h2 className='guide-h2'>How do I create a store on Mosganda?</h2></Typography>
            ...
            <AccordionDetails>
              ...
              <p>First, you need to register and log in to your account. For Information on how to register, visit the <q>How to register and login</q> button above. Once you have logged in to your account.</p>
                  ...
                  <p>Click on <q>Create Store</q> button. You can also find <q>Create Store</q> link from the dropdown that appears when you move the mouse over your name, at the top of the screen.</p>
                  <p>Fill the <q>Create Store</q> form with information about your store.</p>
                  <p>Click <q>Create</q>. This will create your store in a minute.</p>
                  <p>To always access your store, when you log in to Mosganda, move the mouse over your name at the top of the screen.</p>
                  <p>Click on <q>Userstore</q>.</p>
            ...
            <AccordionDetails>
              ...
              <h5>Add Items To Your Store</h5>
                <p>If you have created your store, you can start adding items you want to sell. Move the mouse to your name, at the top of the page. Click on <q>Userstore</q>.</p>
                  ...
                  <p>Click on the <q>Add items for sale</q> button.</p>
                <p>Enter the information about the item and click <q>Create Product</q>.</p>
                <p>If successful, you will be redirected to your store. Repeat the steps to add more items for sale. At this point, you are still the only one seeing your product(s).</p>
                <p>Click on the <q>Post</q> button to display your product on the product page for sale.</p>
        ...
        >
          <Typography><h2 className='guide-h2'>I can't find my items/products on the products page and my store, what happened?</h2></Typography>
            ...
            <AccordionDetails>
              ...
              <h5>(1) Your items have been paid for</h5>
              ...
              <h5>(2) You have not posted the item(s).</h5>
        ...
        >
          <Typography><h2 className='guide-h2'>What is Post and Unpost in my store?</h2></Typography>
            ...
            <AccordionDetails>
              ...
              <h5>When should you <q>Unpost</q> your store or products?</h5>
        ...
        >
          <Typography><h2 className='guide-h2'>What is store URL?</h2></Typography>
            ...
            <AccordionDetails>
              ...
              <h5>How to share my store URL</h5>
        ...
        >
          <Typography><h2 className='guide-h2'>How do I know if a customer has placed an order or paid for my item/product?</h2></Typography>
            ...
            <AccordionDetails>
              <h5>Items ordered and paid for</h5>
              ...
              <p>Once you have successfully send the goods to the buyer, click on the <q>Withdraw</q> button.</p>
              ...
              <h5>Items ordered but not yet paid for</h5>
        ...
        >
          <Typography><h2 className='guide-h2'>How do I get my money for items I sell?</h2></Typography>
            ...
            <AccordionDetails>
              ...
              <p>In the dropdown, click on <q>Sold Items</q>, click on the <q>Withdraw</q> button that is attached to the item.</p>
              <p>In the withdrawal form that appears, fill in your account information and click on <q>Submit</q></p>
              <p>You will recieve your money within 24 hours.</p>
        ...
        >
          <Typography><h2 className='guide-h2'>What is Chat on Mosganda?</h2></Typography>
            ...
            <AccordionDetails>
              ...
              <p>Note that you will have to log in before you can chat with a seller/user.</p>
              ...
              <p>(b) For every product, there is a <q>View-store</q> button. This button takes you to the seller's store where you find details of the seller.</p>
              <p>(c) You can also click on the <q>stores</q> button on the home page, then click on a store to get details of the seller.</p>
              <h5>How to chat</h5>
             
                <p>Copy the name of the seller, click on the <q>Chat</q> button at the top of the page.</p>
                <p>In the Chat page, click on the <q>Search user</q> text/icon, type/paste the copied name in the popup, and click on the <q>Go</q> button</p>
                <p>If the user is found, click on it and start chatting by sending a message.</p>
        ...
        >
          <Typography><h2 className='guide-h2'>How can I chat with a seller on Mosganda?</h2></Typography>
            ...
            <AccordionDetails>
              <p>There are many ways to chat with a seller. Let me show you two ways:</p>
              <div>
                <h5>(1) Go to the seller's store</h5>
                <p>From the homepage where we have items listed by sellers, click on the <q>View store</q> button attached to any product. This will take you to the seller's shop.</p>
                <p>In the seller's store, click on <b>Message</b>. This will add the seller to your chat list, and redirect you to the chat page.</p>
                <p>In the chat page, click on the seller and start chatting by sending message(s).</p>
              </div>
              <div>
                <h5>(2) Find the seller by name.</h5>
              <p>You can aslo communicate/chat with a seller on Mosganda using the <q>Chat</q> button at the top of the page.</p>
              <p>To chat with a seller, you find the seller by name. There are many ways you can get the name of the seller.</p>
              <p>(a) When you click on a product or <q>detail</q> button of a product, you will see the name of the seller.</p>
          ...
          <Typography><h2 className='guide-h2'>How can I chat with a buyer on Mosganda?</h2></Typography>
            ...
            <AccordionDetails>
              ...
              <h5>How to chat</h5>
                ...
                <p>Copy the name of the buyer/customer, click on the <b>Chat</b> button at the top of the page.</p>
                <p>In the Chat page, click on the <b>Search user</b> text/icon, type/paste the copied name in the popup, and click on the <b>Go</b> button</p>
                <p>If the user is found, click on it and start chatting by sending a message.</p>
      ...
      <Accordion>
        ...
        >
          <Typography> <h2 className='guide-h2'>Is it free to sell on Mosganda?</h2></Typography>
            ...
            <AccordionDetails>
              <p>Yes, it is free to sell on Mosganda.</p>
               <h5>Our service charge</h5>
